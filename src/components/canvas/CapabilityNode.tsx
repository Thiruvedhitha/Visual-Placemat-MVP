...
function CapabilityNode({ data, id, selected }: NodeProps<CapabilityNodeData>) {
    ...
    return (
      <div
        ...
        style={{
          ...
          borderRadius: "8px",
          background: bgColor,
          border: `2.5px solid ${selected ? "#f59e0b" : bgColor}`,
          boxShadow: selected
            ? "0 0 0 3px #f59e0b"
  ...
  if (data.level === 1) {
    const headerColor = LEVEL_COLORS[1];
    ...
    return (
      <div
        ...
        style={{
          ...
          borderRadius: "8px",
          overflow: "hidden",
          border: `2px solid ${selected ? "#f59e0b" : headerColor}`,
          boxShadow: selected
            ? "0 0 0 2.5px #f59e0b"
  ...
  // ── L2: Light blue card matching sidebar L2 color ──
  if (data.level === 2) {
    return (
      <div
        data-capability-node-id={id}
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "0 10px",
        background: "#fff",
        border: `2px solid ${LEVEL_COLORS[2]}`,
        borderRadius: "4px",
        cursor: "grab",
        userSelect: "none",
        boxShadow: selected
